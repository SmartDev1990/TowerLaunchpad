import { ChainId, Currency, currencyEquals, JSBI, Price } from '@smartdev1990/tower-sdk'
import { useMemo } from 'react'
import useActiveWeb3React from 'hooks/useActiveWeb3React'
import tokens, { cmpTestTokens } from 'config/constants/tokens'
import { PairState, usePairs } from './usePairs'
import { wrappedCurrency } from '../utils/wrappedCurrency'

const BUSD = cmpTestTokens.busd
...
export default function useBUSDPrice(currency?: Currency): Price | undefined {
  ...
  const tokenPairs: [Currency | undefined, Currency | undefined][] = useMemo(
    () => [
      ...
      [wrapped?.equals(BUSD) ? undefined : wrapped, chainId === ChainId.CMP_TESTNET ? BUSD : undefined],
      [chainId ? WBNB : undefined, chainId === ChainId.CMP_TESTNET ? BUSD : undefined],
    ],
